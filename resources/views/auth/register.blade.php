                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register', app()->getLocale()) }}">
                            ...
                            <div class="form-group row">
                                <label for="eula"
                                       class="col-md-4 col-form-label text-md-right">{{__('auth.eula')}}</label>

                                <div class="col-md-6">
                                    <input id="eula" type="checkbox" class="form-control" name="eula" required>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="policy"
                                       class="col-md-4 col-form-label text-md-right">{!! __('auth.policy') !!}</label>

                                <div class="col-md-6">
                                    <input id="policy" type="checkbox" class="form-control" name="policy" required>
                                </div>
                            </div>
